...
// lab1b-server.c
//
// Server connects with the client, receives the client's commands,
// and sends the commands to the shell. The server then serves the
// client the outputs of those commands.
//
