...
// lab1b-client.c
//
// Client opens a connection to a server specified by the `--port` option.
// The client can then send input from the keyboard to the server (while
// echoing to the display), and send input from the server to the display.
//
